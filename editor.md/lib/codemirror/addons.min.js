...
CodeMirror.runMode = function(string, modename, callback, options) {
  var modespec = CodeMirror.findModeByName(modename);
  var mode = CodeMirror.getMode(CodeMirror.defaults, modespec ? modespec.mode : modename);
